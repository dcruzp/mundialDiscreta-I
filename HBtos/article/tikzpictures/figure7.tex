...
\begin{document}
    \begin{tikzpicture}[ultra thick]
        ...
        \path   (8,10)  node (a) [circle,draw] {A}
                ...
                (3,5.5) node (n) [circle,draw] {N}
                (5,5.5) node (o) [circle,draw] {O}
                (7,5.5) node (p) [circle,draw] {P}
                (9,5.5) node (q) [circle,draw] {Q}
                (11,5.5) node (r) [circle,draw] {R}
                (13,5.5) node (s) [circle,draw] {S};
