...
%Figura del TURNO 2 
    ...
    \subsection*{\'Arbol generado por backtraking}
    \tikzstyle{miEstilo}= [thin, dotted, ]
    \begin{center}
        \begin{tikzpicture}[ultra thick]
    ...
    \begin{center}    
        \begin{tikzpicture}[ultra thick]
            ...
            \path   (5,10) node (a) [circle,draw,fill = red] {A}
            ...
            \draw[arrows = -{Triangle[open,angle=60:2mm,fill=blue]},blue]  (node cs: name =a ) -- (node cs:name =b);
            ...
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=red]},red] (node cs: name =d ) -- (node cs:name =g);
            ...
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=red]},red] (node cs: name =g ) -- (node cs:name =k);
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=blue]},blue] (node cs: name =g ) -- (node cs:name =l);
            \draw[ultra thick,arrows = -{Triangle[open,angle=60:2mm,fill=blue]},blue] (node cs: name =d ) -- (node cs:name =h);
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=red]},red] (node cs: name =h ) -- (node cs:name =l);
            ...
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=blue]},blue] (node cs: name =i ) -- (node cs:name =n);
            \draw[ultra thick,arrows = -{Triangle[open,angle=60:2mm,fill=red]},red] (node cs: name =f ) -- (node cs:name =i);
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=blue]},blue] (node cs: name =f ) -- (node cs:name =j);
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=red]},red] (node cs: name =j ) -- (node cs:name =n);
            \draw[thick,arrows = -{Triangle[open,angle=60:2mm,fill=blue]},blue] (node cs: name =j ) -- (node cs:name =o);
        \end{tikzpicture}
    \end{center}
\end{document}