...
%Figura del TURNO 2 
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \path   (5,10)  node (a) [circle,draw,fill= gray] {\mbox{1}}
                    (4,9) node (b) [circle,draw,fill= gray] {\mbox{1}}
                    (6,9) node (c) [circle,draw,fill= gray] {\mbox{1}}
                    (3,8) node (d) [circle,draw,fill= blue] {\mbox{1}}
                    (5,8) node (e) [circle,draw,fill= gray] {\mbox{2}}
                    (7,8) node (f) [circle,draw,fill= gray] {\mbox{1}}
                    (2,7) node (g) [circle,draw,fill= gray] {\mbox{1}}
                    (4,7) node (h) [circle,draw,fill= blue] {\mbox{3}}
                    (6,7) node (i) [circle,draw,fill= gray] {\mbox{3}}
                    (8,7) node (j) [circle,draw,fill= gray] {\mbox{1}}
                    (1,6) node (k) [circle,draw,fill= gray] {\mbox{1}}
                    (3,6) node (l) [circle,draw,fill= gray] {\mbox{4}}
                    (5,6) node (m) [circle,draw,fill= blue] {\mbox{6}}
                    (7,6) node (n) [circle,draw,fill= gray] {\mbox{4}}
                    (9,6) node (o) [circle,draw,fill= gray] {\mbox{1}}
                    (0,5) node (p) [circle,draw,fill= gray] {\mbox{1}}
                    (2,5) node (q) [circle,draw,fill= gray] {\mbox{5}}
                    (4,5) node (r) [circle,draw,fill= red] {\mbox{10}}
                    (6,5) node (s) [circle,draw,fill= gray] {\mbox{10}}
                    (8,5) node (t) [circle,draw,fill= gray] {\mbox{5}}
                    (10,5) node (u) [circle,draw,fill= gray] {\mbox{1}};
